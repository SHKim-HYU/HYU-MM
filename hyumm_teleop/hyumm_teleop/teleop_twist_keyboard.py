#!/usr/bin/env python3
"""Keyboard teleop -> /cmd_vel (ROS2 port of teleop_twist_keyboard).

Publishes geometry_msgs/Twist on 'cmd_vel'. Holonomic-capable (strafe with the
shifted keys), matching the original Noetic node's bindings.
"""
...
class PublishThread(threading.Thread):
    def __init__(self, node, rate):
        ...
        # Set timeout to None if rate is 0 (publish only on new data).
        if rate != 0.0:
